...
int main()
{
  ...
  // my_char3 is no longer alphabetic because 'z' is the last character in the alphabet
  ...
  // my_short2 was the maximum value for data type short
  ...
  std::cout << ", after adding 1: " << std::dec << my_int3
    ...
    // my_short3 is 0 because the maximum value for unsigned short is 65535.
